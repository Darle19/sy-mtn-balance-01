...
return [
  ...
  ",
    ...
    FROM FB_subscriptions
    WHERE `status` IN (1, 3, 5, 6)
    AND DATE(trial_stop_date) = CURDATE()
    ...
    AND DATE(charge_request_date)=CURDATE();
    ",
